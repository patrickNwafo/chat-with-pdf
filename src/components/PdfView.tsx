...
// gsutil cors set cors.json gs:'//chat-with-pdf-fd86a.appspot.com
// go to >>> https://console.cloud.google.com/
// create new file in editor calls cors.json
// run >>> // gsutil cors set cors.json gs://chat-with-pdf-fd86a.appspot.com
    ...
    return (
        <div className="flex flex-col justify-center items-center">
            <div className=" sticky top-0 z-50 bg-gray-100 p-2 rounded-b-lg">
                <div className="max-w-6xl px-2 grid-cols-6 gap-2 grid">
                    <Button
                        variant="outline"
